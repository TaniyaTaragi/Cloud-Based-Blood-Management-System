				...
				<div class="row contactus">
					<div class="col-md-6 offset-md-3">
						...
						<hr class="white-bar">
							...
							<div class="details" style="text-align: center; display: flex; justify-content: center; align-items: center; gap: 10px;">
    <p style="margin: 0;">
        94******** <i class="fa fa-phone"></i> |  
        redlife123456@gmail.com <i class="fa fa-envelope"></i>
    </p>
</div>
